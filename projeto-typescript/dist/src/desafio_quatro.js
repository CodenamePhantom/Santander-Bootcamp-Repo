...
searchButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let queryObj = document.getElementById('search');
...
function preencherSenha() {
    let passwordObj = document.getElementById('senha');
    password = passwordObj.value;
    validateLoginButton();
}
function preencherLogin() {
    let usernameObj = document.getElementById('login');
    username = usernameObj.value;
    validateLoginButton();
}
function preencherApi() {
    let apiKeyObj = document.getElementById('api-key');
