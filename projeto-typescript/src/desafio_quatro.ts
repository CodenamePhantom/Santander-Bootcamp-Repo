...
searchButton.addEventListener('click', async () => {
  ...
  let queryObj = document.getElementById('search') as HTMLInputElement;
  let query: string = queryObj.value;
...
function preencherSenha() {
  let passwordObj = document.getElementById('senha') as HTMLInputElement;
  password = passwordObj.value;
  validateLoginButton();
}

function preencherLogin() {
  let usernameObj =  document.getElementById('login') as HTMLInputElement;
  username = usernameObj.value;
  validateLoginButton();
}

function preencherApi() {
  let apiKeyObj = document.getElementById('api-key') as HTMLInputElement;
